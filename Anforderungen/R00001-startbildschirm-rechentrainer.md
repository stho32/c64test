...
Der Rechentrainer bekommt einen Startbildschirm im Textmodus, der vor dem eigentlichen Übungsmodus erscheint. Der Schriftzug "RECHENTRAINER" steht als mehrzeilige PETSCII-Blockschrift oben, darunter leuchtet "START" in einem Farbverlauf. Der Bildschirmhintergrund wechselt gleichmäßig und langsam seine Farbe, während die Animation in einer Endlosschleife läuft, bis eine beliebige Taste gedrückt wird. Nach 5 gelösten Aufgaben kehrt der Trainer zum Startbildschirm zurück.
...
- Then: "RECHENTRAINER" steht als Blockschrift oben, "START" darunter in Farbverlauf, Hintergrund wechselt gleichmäßig die Farbe
...
### Darstellung
- [ ] "RECHENTRAINER" erscheint als mehrzeilige PETSCII-Blockschrift
- [ ] "START" erscheint darunter, gut lesbar abgesetzt vom Titel
- [ ] Bildschirmhintergrund ändert seine Farbe gleichmäßig und fortlaufend
- [ ] "START"-Text durchläuft einen sichtbaren Farbverlauf, unabhängig vom Hintergrund
...
### Technik
- [ ] Umsetzung in reinem BASIC V2 mit POKE auf Bildschirm-/Farb-RAM, kein Assembler/SYS
...
|---|---|
| Startbildschirm-Routine | Blockschrift-Ausgabe "RECHENTRAINER", "START"-Anzeige mit Farbverlauf, Hintergrund-Farbwechsel, nicht-blockierende Tastaturabfrage (`GET`) |
